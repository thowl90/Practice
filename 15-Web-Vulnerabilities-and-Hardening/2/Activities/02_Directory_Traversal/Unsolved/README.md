...
- Ensure the container is running by running the command `docker ps`. If they are not running, run the command `cd /home/sysadmin/Documents/web-vulns && docker-compose up`.
