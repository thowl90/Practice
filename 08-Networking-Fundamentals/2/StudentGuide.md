...
- Select which interface you want to capture traffic from.  Your option will vary, but select the network that has movement on the sparkline.

![interfaces](Images/ws_interface.png)

After selecting your network, Wireshark changes to the packet capture view.
