...
We have a whole module later in the program dedicated to cryptography, where will cover hashing in depth. For now we will only cover a few basics. Note the following about hashes:
